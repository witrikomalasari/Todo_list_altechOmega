...
export const AltechButton: FC<IAltechButtonProps> = ({
  disabled,
  onPress,
  title,
  variant = 'solid',
  ...
  if (disabled)
    ButtonStyle = {...ButtonStyle, backgroundColor: AltechColors.gray};
  ...
  // styling for text
  let textColors = variant === 'solid' ? 'white' : AltechColors.primary;
...
const styles = StyleSheet.create({
  ...
  outline: {
    ...
    borderRadius: 8,
    borderWidth: 1,
    borderColor: AltechColors.primary,
  },
});
